clarinet_one_part = \relative c' {
  ...
  r8  \once \override NoteHead.style = #'slash g16^\markup {sim }  r16 
  r4  |
  ...
  r4 
  \once \override NoteHead.style = #'triangle g16^\markup {teeth }  r16  r8 
  r4 
  r8  fis,,8~  |
  ...
  % ________________________________________bar 20 :
  \once \override NoteHead.style = #'slash g4 
  r8  \once \override NoteHead.style = #'triangle g16^\markup {teeth }  <fis,, g >16^\markup {sing } 
  r4 
