flute_one_part = \relative c' {
  ...
  \once \override NoteHead.style = #'triangle c2~ 
  \once \override NoteHead.style = #'triangle c16  b16:32^\markup {frull. }  r8 
  r8  r16  e16  |
  ...
  r8  \once \override NoteHead.style = #'harmonic c8~^\markup {B.P. } 
  ...
  % ________________________________________bar 19 :
  r2 
  r8  \once \override NoteHead.style = #'triangle c8~ 
  \once \override NoteHead.style = #'triangle c4~  |
  % ________________________________________bar 20 :
  ...
  \xNote c4 
  r4 
  r8  b16:32^\markup {frull. }  \once \override NoteHead.style = #'harmonic c16^\markup {T.R. }  |
  % ________________________________________bar 25 :
  r16  e16  dis16  e16 
